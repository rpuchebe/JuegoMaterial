...
public class Principiante extends AppCompatActivity implements View.OnClickListener{
    TextView texto;
    ...
    private void cargarJuego() {
        ...
        bloque1 = (Button)findViewById(R.id.b12);
        bloque2 = (Button)findViewById(R.id.b13);
        bloque3 = (Button)findViewById(R.id.b14);
        bloque4 = (Button)findViewById(R.id.b22);
        bloque5 = (Button)findViewById(R.id.b24);
        bloque6 = (Button)findViewById(R.id.b32);
        bloque7 = (Button)findViewById(R.id.b33);
        bloque8 = (Button)findViewById(R.id.b34);
            ...
            if(bloqueVisible != null && bloqueVisible.getText().toString().compareTo(temp.getText().toString()) == 0 && bloqueVisible.getId() != temp.getId()){
                ...
                if(parejasEncontradas == 0){
                    ...
                    if(extras!=null){
                        ...
                        String dato = extras.getString("USER");
                        fun.Crear(context,"Principiante",dato, puntos);

                    }
                    intent = new Intent(Principiante.this, Listado.class);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            ...
            case R.id.fab:
                ...
                Intent intent = new Intent(Principiante.this, Listado.class);
                startActivity(intent);
