...
public class Intermedio extends AppCompatActivity implements View.OnClickListener{
    TextView texto;
            ...
            if(bloqueVisible != null && bloqueVisible.getText().toString().compareTo(temp.getText().toString()) == 0 && bloqueVisible.getId() != temp.getId()){
                ...
                if(parejasEncontradas == 0){
                    ...
                    if(extras!=null){
                        ...
                        String dato = extras.getString("USER");
                        fun.Crear(context,"Intermedio",dato, puntos);

                    }
                    intent = new Intent(Intermedio.this, Listado.class);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            ...
            case R.id.fab:
                ...
                Intent intent = new Intent(Intermedio.this, Listado.class);
                startActivity(intent);
